...
model = gensim.models.KeyedVectors.load_word2vec_format('embedding_gene\\GoogleNews-vectors-negative300.bin', binary=True)
...
with open(output_file, "a") as f:
    for chunk in pd.read_csv("dataset\\tweet.csv", chunksize=chunksize):
        print("处理到块:",chunk_no)
        chunk_no+=1
